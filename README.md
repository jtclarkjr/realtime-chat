...
User can see everything including personal chats with AI chatbot (uses a custom
built AI Agent based on
...
This way can control where to deploy as websocket/ SSE server doesnt work on
serverless and can decouple AI Agent to its own service
